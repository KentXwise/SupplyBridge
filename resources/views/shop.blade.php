            ...
            <div class="slide-split h-100 d-block d-md-flex overflow-hidden">
              <div class="slide-split_text position-relative d-flex align-items-center"
                ...
                <div class="slideshow-text container p-3 p-xl-5">
                  ...
                  <p class="mb-0 animate animate_fade animate_btt animate_delay-5">"Empower your business with ease—our
                    online platform connects retailers to quality goods at unbeatable bundle deals.
                    Discover new styles, stock up on essentials, and elevate your offerings with just a few clicks."
                  </p>
                </div>
              </div>
          ...
          <div class="product-card mb-3 mb-md-4 mb-xxl-5">
            <div class="pc__img-wrapper">
              ...
              <a href="{{route('cart.index')}}"
                class="pc__atc btn anim_appear-bottom btn position-absolute border-0 text-uppercase fw-medium btn-warning md-3">Go
                to Cart</a>
              @else
